...
// Think of it like a room inside of a room. nestedFunction is inside of myFunction where "internal" is located.
// Because of this, nestedFunction has access to the information. This is not true the other way around however.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    let lowerCaseNames= zooAnimals.map((item)=>{
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const popUnder5 = zooAnimals.filter((item)=>{
  ...
  */
  ...
  function USApop(zooAnimals){
    const totalPop = zooAnimals.reduce((accumulator,currentValue)=>{
